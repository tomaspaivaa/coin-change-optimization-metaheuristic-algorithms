...
int main() {
    ...
    for (i = 0; i < runs; i++) {
        ...
        //---------------------------------
        if(hibridoFlag == 1) {
            for(int t = 0; t < evolutiveAlgorithmParameters.populationSize; t++) {
                population[t].fitness = trepaColinas(population[t].p, coinsTypeArray, evolutiveAlgorithmParameters, 10000, 1);
            }
        }
        //---------------------------------
        ...
        //---------------------------------
        if(hibridoFlag == 2) {
            for(int r = 0; r < evolutiveAlgorithmParameters.populationSize; r++) {
                population[r].fitness = trepaColinas(population[r].p, coinsTypeArray, evolutiveAlgorithmParameters, 10000, 1);
            }
        }
        //---------------------------------
